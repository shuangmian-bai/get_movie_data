"""红牛资源（hongniuziyuan.net）插件主类、映射模板、抽象方法实现"""
...
class HongniuzyPlugin(MediaSourcePlugin):
    """红牛资源（hongniuziyuan.net）站点插件。
    ...
    # ---- 站点元信息 ----
    base_url = "http://hongniuziyuan.net"
    source_name = "红牛资源"
    source_desc = "红牛资源（hongniuziyuan.net）：苹果CMS 站，影视搜索 / 详情 / m3u8 播放地址解析"
