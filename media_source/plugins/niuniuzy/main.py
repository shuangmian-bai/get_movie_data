"""牛牛资源（niuniuzy.cc）插件主类、映射模板、抽象方法实现"""
...
class NiuniuzyPlugin(MediaSourcePlugin):
    """牛牛资源（niuniuzy.cc）站点插件。

    站点为苹果CMS；官方采集接口（niuniuzy4.com）已开放详情与播放，
    ...
    source_name = "牛牛资源"
    source_desc = (
        "牛牛资源（niuniuzy.cc）：苹果CMS 采集接口（niuniuzy4.com）；"
