"""360 资源站（360zy5.com）插件主类、映射模板、抽象方法实现"""
...
class Zy360Plugin(MediaSourcePlugin):
    """360 资源站（360zy5.com）站点插件。

    原始字段：title/href/cover/type/year/intro + episodes（name/url/index）。
    站点为苹果CMS，官方采集接口支持关键词搜索，
    播放串内即为直接 m3u8 地址。
    """

    # ---- 站点元信息 ----
    base_url = "https://360zy5.com"
    source_name = "360资源站"
    source_desc = "360资源站（360zy5.com）：苹果CMS 站，影视搜索 / 详情 / m3u8 播放地址解析"
